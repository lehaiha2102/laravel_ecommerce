...
class ManufacturerRequest extends FormRequest
{
    ...
    {
        return [
            'name'              => 'required|unique:manufacturers,name|max:255|string',
            'phone'             => 'required|unique:manufacturers,phone|regex:/^0[0-9]{9}$/|max:255',
            'email'             => 'required|email|unique:manufacturers,email|max:255|regex:/^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$/',
